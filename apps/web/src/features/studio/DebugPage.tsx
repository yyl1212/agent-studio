...
function runStatusLabel(status: DebugOverview['run']['status']) { return { queued: '◌ 排队中', running: '◌ 运行中', recovery_required: '⚠ 等待人工恢复', cancelling: '◌ 取消中', completed: '✓ 已完成', failed: '× 失败', cancelled: '— 已取消' }[status] }
