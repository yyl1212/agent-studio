...
export interface StudioQuickToolsProps {
  ...
  shortcutHelpTriggerRef?: Ref<HTMLElement>
...
export function StudioQuickTools(props: StudioQuickToolsProps) {
  return <nav className="studio-quick-tools" aria-label="画布快捷工具">
    ...
    <details className="studio-shortcut-help" open={props.shortcutHelpOpen} onToggle={(event) => props.onShortcutHelpOpenChange?.(event.currentTarget.open)}>
      <summary ref={props.shortcutHelpTriggerRef}>快捷键帮助</summary>
      <div>
