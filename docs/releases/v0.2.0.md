...
`v0.2.0` 正式建立公共 Go Node SDK、契约测试工具、节点脚手架和确定性注册代码生成，并提供 Echo、Retriever、Webhook 三类官方扩展节点。GitHub Release 公开后包含 macOS/Linux 的 amd64、arm64 CLI 归档、SHA-256 校验和和逐归档 SPDX JSON SBOM。
