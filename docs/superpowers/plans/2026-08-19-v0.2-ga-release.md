...
```bash
grep -F '当前正式开发者预览版本为 `v0.2.0`' README.md
```
...
! sed -n '17,61p' README.md | rg 'v0\.2\.0-rc\.2|当前候选版本|标签创建后'
...
gh run list --workflow Release --event push --branch v0.2.0 --limit 1
```
