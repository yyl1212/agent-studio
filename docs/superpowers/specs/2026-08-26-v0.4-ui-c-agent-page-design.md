...
公开事件只包含 sequence、type、粗粒度 status 和 timestamp。它不包含 nodeId、nodeType、activePorts、input、output、error、redactedPaths、dataBytes 或管理端关联字段。前端按事件顺序显示“步骤 1、步骤 2”，不推断或展示画布结构。
