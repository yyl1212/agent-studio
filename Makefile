.PHONY: db-up db-down observability-up observability-down observability-check observability-verify dev-api dev-worker dev-web dev-stack generate check-generated test-api-integration verify verify-go-quick verify-web-quick verify-quick verify-node-index test-e2e test-sdk-e2e test-durable-runs-e2e test-rc-capacity-e2e test-v05-upgrade-rollback-e2e backup-create backup-inspect backup-restore-dry-run backup-restore test-backup-e2e verify-backup-docs verify-durable-run-docs verify-backup-fixture release-tools release-check release-snapshot release-preflight verify-workflows verify-release
...
verify-go-quick: check-generated verify-backup-docs verify-durable-run-docs verify-backup-fixture
...
verify-web-quick:
	sh scripts/check-playwright-worker_test.sh
	corepack pnpm@10.34.5 --filter @agent-studio/web generate:api
	git diff --exit-code -- apps/web/src/lib/api/generated.ts
	corepack pnpm@10.34.5 lint
